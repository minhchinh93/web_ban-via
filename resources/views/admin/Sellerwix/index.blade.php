    ...
    <div class="row mt">
        <div class="col-lg-12">
                <div class="content-panel">
                    <div class="row">
                        <div class="col-lg-11">
                            <h4><i class="fa fa-angle-right"></i> <span class="badge bg-primary"> total_Order : {{ $total ?? 0}}</span> | <span class="badge bg-important">total_prices : {{ $total_price ?? 0 }} $</span> | <span class="badge bg-success">total_shipping_prices : {{ $shipping_price ?? 0  }}  $</span> | <span class="badge bg-inverse">total_sw_prices : {{ $sw_prices ?? 0 }}  $</span> </h4>
                        </div>
