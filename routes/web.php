...
Route::get('dasboa/{id}', [HomeController::class, 'dasboa'])->middleware('auth')->name('dasboa');
Route::get('AccountHistory', [AccountHistoryController::class, 'index'])->middleware('auth')->name('AccountHistory');
